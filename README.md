...
- looking at the active HTML in DevTools, it is apparent that all the moving pizzas I detected in the LAYERS analysis above are generated by the `append` statement shown here:
```
